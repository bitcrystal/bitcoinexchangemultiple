<?php
error_reporting(0);
$sql = "SELECT * FROM ordersfilled WHERE want='".$my_coins->coins_names_prefix[1]."' and trade_id='".$my_coins->coins_names_prefix[0]."_".$my_coins->coins_names_prefix[1]."_".$my_coins->coins_names_prefix[2]."' and processed='1' ORDER BY rate DESC";
...
if($count!=0) {
   ...
   $Query = mysql_query("SELECT date, action, amount, rate, total FROM ordersfilled WHERE want='".$my_coins->coins_names_prefix[1]."' and trade_id='".$my_coins->coins_names_prefix[0]."_".$my_coins->coins_names_prefix[1]."_".$my_coins->coins_names_prefix[2]."' and processed='1' ORDER BY id DESC");
